...
export function AgentCard({ tone, label, footer }: AgentCardProps) {
  ...
  return (
    <div className={`agent-card tone-${tone}`}>
      <div ref={ref} className={`agent-art-frame${inView ? " in-view" : ""}`}>
...
function FinanceAnalystArt() {
  return (
    <svg className="aa-svg" viewBox="0 0 420 420" role="img" aria-label="Finance Analyst: department variance with anomaly callout and root-cause drilldown">
      <defs>
      ...
      <g transform="translate(32 30)">
        <rect width="356" height="360" rx="16" fill="#ffffff" stroke="rgba(108,64,212,0.18)" />

        {/* Title row */}
        <text x="20" y="32" fontSize="10" fontWeight="800" fill="#5a2bd6" letterSpacing="0.6">VARIANCE BY DEPARTMENT</text>

        {/* Grid */}
        <g stroke="rgba(108,64,212,0.10)" strokeWidth="1">
          <line x1="36" y1="80" x2="336" y2="80" />
          <line x1="36" y1="140" x2="336" y2="140" />
          <line x1="36" y1="200" x2="336" y2="200" />
        </g>
        <line x1="36" y1="260" x2="336" y2="260" stroke="rgba(108,64,212,0.35)" strokeWidth="1.5" strokeLinecap="round" />

        {/* Y-axis labels */}
        <g fontSize="8" fontWeight="700" fill="#7e5fb7" textAnchor="end">
          <text x="30" y="83">30%</text>
          <text x="30" y="143">20%</text>
          <text x="30" y="203">10%</text>
          <text x="30" y="263">0</text>
        </g>

        {/* Bars (baseline y=260, scale 6px/unit) */}
        <g className="aa-fa-bars">
          <rect className="aa-fa-bar aa-fa-b1" x="56"  y="200" width="32" height="60"  rx="5" fill="url(#aaPurpleBarSoft)" />
          <rect className="aa-fa-bar aa-fa-b2" x="100" y="170" width="32" height="90"  rx="5" fill="url(#aaPurpleBarSoft)" />
          <rect className="aa-fa-bar aa-fa-b3 aa-fa-anomaly" x="144" y="80" width="32" height="180" rx="5" fill="url(#aaPurpleBar)" />
          <rect className="aa-fa-bar aa-fa-b4" x="188" y="188" width="32" height="72"  rx="5" fill="url(#aaPurpleBarSoft)" />
          <rect className="aa-fa-bar aa-fa-b5" x="232" y="218" width="32" height="42"  rx="5" fill="url(#aaPurpleBarSoft)" />
          <rect className="aa-fa-bar aa-fa-b6" x="276" y="164" width="32" height="96"  rx="5" fill="url(#aaPurpleBarSoft)" />
        </g>

        {/* Anomaly callout */}
        <g className="aa-fa-callout" transform="translate(160 68)">
          <rect x="-26" y="-12" width="52" height="20" rx="10" fill="#5a2bd6" />
          <text x="0" y="2" fontSize="10" fontWeight="800" fill="#fff" textAnchor="middle">+24%</text>
          <path d="M0 8 L0 16" stroke="#5a2bd6" strokeWidth="1.5" />
        </g>

        {/* X-axis labels */}
        <g fontSize="9" fontWeight="800" fill="#5a2bd6" textAnchor="middle" letterSpacing="0.4">
          <text x="72"  y="280">R&amp;D</text>
          <text x="116" y="280">MKTG</text>
          <text x="160" y="280">OPS</text>
          <text x="204" y="280">SALES</text>
          <text x="248" y="280">G&amp;A</text>
          <text x="292" y="280">IT</text>
        </g>
...
function SearchArt() {
  return (
    <svg className="aa-svg" viewBox="0 0 420 420" role="img" aria-label="Search agent: trusted finance answers with citation">
      <defs>
      ...
      {/* Search bar */}
      <g className="aa-sr-prompt" transform="translate(40 40)">
        <rect width="340" height="56" rx="28" fill="#ffffff" stroke="rgba(160,120,0,0.28)" />
        <g transform="translate(28 28)" stroke="#a87f00" strokeWidth="2.6" fill="none" strokeLinecap="round">
          <circle r="9" />
          <line x1="7" y1="7" x2="13" y2="13" />
        </g>
        <rect x="56" y="24" width="200" height="8" rx="4" fill="#7a5400" />
      </g>

      {/* Answer card */}
      <g className="aa-sr-row" transform="translate(40 120)">
        <rect width="340" height="260" rx="20" fill="#ffffff" stroke="#e6a900" strokeWidth="1.6" />

        {/* Source pill */}
        <g transform="translate(24 24)">
          <rect width="132" height="24" rx="12" fill="#fff5cf" stroke="rgba(160,120,0,0.35)" />
          <g transform="translate(14 8)" fill="#f5d04a" stroke="#a87f00" strokeWidth="1.2" strokeLinejoin="round">
            <path d="M0 0 H6 L9 3 V10 H0 Z" />
            <path d="M6 0 V3 H9" fill="none" />
          </g>
          <text x="30" y="16" fontSize="9" fontWeight="800" fill="#7a5400" letterSpacing="0.4">
            REV-REC POLICY
          </text>
        </g>
        ...
        <g transform="translate(24 76)">
          <rect width="292" height="10" rx="5" fill="#7a5400" />
          <rect y="22" width="268" height="10" rx="5" fill="#7a5400" />
          <rect y="44" width="240" height="10" rx="5" fill="#7a5400" />
          <rect y="66" width="180" height="10" rx="5" fill="#c79a2a" />
        </g>

        {/* Cited footer */}
        <g className="aa-sr-check" transform="translate(24 200)">
          <rect width="156" height="36" rx="18" fill="#f5d04a" />
          <g transform="translate(20 18)">
            <circle r="10" fill="#7a5400" />
            <path d="M-4 0 L-1 3 L4 -3" stroke="#fff5cf" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          </g>
          <text x="40" y="23" fontSize="11" fontWeight="800" fill="#3d2c00" letterSpacing="0.4">
            CITED · §4.2
          </text>
        </g>
      </g>
      ...
      <g transform="translate(232 70)" className="aa-da-output">
        ...
        <g transform="translate(14 50)">
          ...
          <g transform="translate(0 42)">
            <g className="aa-da-row aa-da-r2">
              <rect width="128" height="34" rx="6" fill="#f1f4ff" />
          ...
          <g transform="translate(0 84)">
            <g className="aa-da-row aa-da-r3">
              <rect width="128" height="34" rx="6" fill="#f1f4ff" />
          ...
          <g transform="translate(0 126)">
            <g className="aa-da-row aa-da-r4">
              <rect width="128" height="34" rx="6" fill="#f1f4ff" />
